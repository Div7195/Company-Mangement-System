...
public class HR extends Employee {
    ...
    HR(String name, int age, String Designation,String empcode,int status) {
    ...
    public void addNewEmployees(ArrayList<HR> employeeList ,String name,int age,String designation){
        ...
        HR newDesignEmployee = new HR(name, age, designation,empcode,status);
...
public void removeEmployeesData(ArrayList<HR> employeeList,String code){
    try{
                String intValue=code.substring(2, 5);                                
            try{
                Integer.valueOf(intValue);                                  
...
public void getDataFromFiles(String filename,ArrayList<HR> employeeList){
    try{
    ...
    public void sort1EmployeesData(ArrayList<HR> employeeList){        
        ArrayList<HR> al=new ArrayList<>();    
    for(int i=0;i<employeeList.size();i++){
        al.add(employeeList.get(i));
    }
        Collections.sort(al,new Comparator<HR>(){
        public int compare(HR e1,HR e2){
